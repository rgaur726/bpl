...
export default function GabbarCaptainPage() {
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-slate-900 via-red-900 to-orange-900 relative overflow-hidden">
      {/* Animated background */}
              ...
              <CardContent className="p-6 h-full flex flex-col">
                <div className="flex mb-6">
                  <div className="bg-gradient-to-br from-slate-700 to-slate-800 w-24 h-32 rounded-xl mr-4 flex flex-col items-center justify-center text-white text-xs shadow-lg border border-white/10">
                    ...
                    <div className="text-xs text-red-400">156 Matches</div>
                  </div>
          ...
          <CardContent className="p-4 h-full">
            ...
            <div className="grid grid-cols-8 gap-2 h-12">
              {Array.from({ length: 8 }, (_, i) => (
                <div
                  key={i}
                  className="bg-gradient-to-br from-slate-700/50 to-slate-800/50 backdrop-blur-sm rounded-lg p-1 text-white text-xs text-center flex flex-col items-center justify-center border border-white/10 hover:border-red-400/30 transition-all duration-300"
                >
                  <div>Player {i + 1}</div>
