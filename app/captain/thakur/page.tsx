...
<Card className="bg-transparent bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-md border border-white/20 shadow-2xl h-96">
          ...
          <div className="col-span-7 grid grid-cols-2 gap-4">
            {/* My Team */}
<Card className="bg-transparent bg-gradient-to-br from-blue-800/30 to-blue-900/30 backdrop-blur-md border border-blue-400/30 shadow-2xl h-[34rem]">
              <CardContent className="p-4 h-full">
                ...
                <div className="bg-gradient-to-r from-slate-900 to-black text-white p-3 text-center rounded-lg border border-blue-400/30" style={{ position: 'absolute', bottom: '1rem', left: '1rem', right: '1rem' }}>
                  <div className="font-semibold flex items-center justify-center space-x-2">
                    <span>Players {myTeamPlayers.length}/12</span>
                  </div>
