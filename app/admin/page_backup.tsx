            ...
            <div className="mt-auto space-y-3">
              ...
              <div className="flex gap-3">
                ...
                <Button
                  ...
                  disabled={currentBid > 0 && !!lastBidder}
                  onClick={async () => {
              ...
              <div className="flex gap-3">
                <Button
                  className="bg-gradient-to-r from-red-600 to-red-700 text-white flex-1 rounded-xl shadow-lg"
                  onClick={async () => {
                    if (confirm('Are you sure you want to reset the entire auction? This will clear all player assignments and reset purses to 50,000.')) {
                      try {
